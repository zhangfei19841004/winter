...
public class ResponseUtil {
    ...
    public static ResponseInfo getResponseInfo(ResponseConstants res){
        return getResponseInfo(res.getRetCode(), res.getRetMsg(), null);
    }

    public static ResponseInfo getResponseInfo(ResponseConstants res, Object data){
        return getResponseInfo(res.getRetCode(), res.getRetMsg(), data);
    }
